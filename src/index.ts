...
async function main() {
    ...
    const projectName:string = answers.project_name;
    const projectTemplate:keyof RepoMap = answers.project_template;
    ...
    try {
        const repoMap:RepoMap = {
            ...
            reactBackendTemplate:'https://github.com/yaseenrehan123/backend-template.git',
